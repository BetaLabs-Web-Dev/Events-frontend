  ...
  return (
    <div className='px-20 py-24 bg-center bg-no-repeat bg-your-image'> 
      <div className="flex flex-col items-center gap-5 bg-transparent">
        <div className="text-3xl font-extrabold bg-transparent font-inter random-title">Beta Lab's</div>
        <div className="text-5xl font-semibold">Android Development</div>
